...
/*
 * @file	freertos/microblaze/sys.h
 * @brief	freertos microblaze system primitives for libmetal.
 */
...
#ifndef __METAL_FREERTOS_MICROBLAZE_SYS__H__
#define __METAL_FREERTOS_MICROBLAZE_SYS__H__
...
#endif /* __METAL_FREERTOS_MICROBLAZE_SYS__H__ */
